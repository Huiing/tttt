...
@implementation JYBChatGroupClearCashView
...
- (void)selectClearCashAction{
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectClearCash)]){
        [self.delegate selectClearCash];
    }
}
