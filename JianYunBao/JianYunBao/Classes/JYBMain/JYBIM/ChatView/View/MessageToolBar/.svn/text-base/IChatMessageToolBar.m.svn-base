...
@interface IChatMessageToolBar ()<UITextViewDelegate>
{
...
@implementation IChatMessageToolBar
...
- (void)setupSubviews
{
    if (_toolBarStyle == IChatMessageToolBarStyleChat) {
        [self chatStyleOfMessageToolBar];
    } else if (_toolBarStyle == IChatMessageToolBarStyleComment) {
        [self commentStyleOfMessageToolBar];
    } else {
        
    }
}

- (void)chatStyleOfMessageToolBar
{
    ...
    [self.styleChangeButton setImage:[UIImage imageNamed:@"语音ing"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"键盘"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"弹出"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"弹出"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"键盘"] forState:UIControlStateSelected];
    ...
    if (!self.moreView) {
        self.moreView = [[DXChatBarMoreView alloc] initWithFrame:CGRectMake(0, (kVerticalPadding * 2 + kInputTextViewMinHeight), self.frame.size.width, 120) type:ChatMoreTypeGroupChat];
...
- (void)commentStyleOfMessageToolBar
{
    CGFloat allButtonWidth = 0.0;
    CGFloat textViewLeftMargin = 6.0;
    ...
    [self.sendButton setTitleColor:[UIColor jyb_blackColor] forState:UIControlStateNormal];
    self.sendButton.titleLabel.font = JYBFont(14);
    ...
    allButtonWidth += CGRectGetWidth(self.sendButton.frame) + kHorizontalPadding * 2.5;
