...
@interface JYBIMSendBillNodeMessageApi : YTKRequest
 ...
 *
 *  @return `JYBIMSendBillNodeMessageApi`
 */
- (instancetype)initBillNoteApiWithEnterpriseCode:(NSString *)enterpriseCode
