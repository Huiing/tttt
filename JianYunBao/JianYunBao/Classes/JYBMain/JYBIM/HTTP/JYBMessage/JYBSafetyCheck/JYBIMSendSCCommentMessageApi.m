//
//  JYBIMSendSCCommentMessageApi.m
//  BDSocketIM
//
...
@implementation JYBIMSendSCCommentMessageApi
{
...
- (instancetype)initSafetyCheckCommentApiWithEnterpriseCode:(NSString *)enterpriseCode userName:(NSString *)username userid:(NSString *)userid orderId:(NSString *)orderId
{
    if (self = [super init]) {
...
- (NSString *)requestUrl
{
    switch (_type) {
        case JYBIMMessageBodyTypeText:
            return JYBBCHttpUrl(@"/phone/SafetyInspectDiscussText!upMessage.action");
            break;
        case JYBIMMessageBodyTypeAudio:
            return JYBBCHttpUrl(@"/phone/SafetyInspectDiscussPhon!upMessage.action");
            break;
        case JYBIMMessageBodyTypeImage:
            return JYBBCHttpUrl(@"/phone/SafetyInspectDiscussPhoto!upMessage.action");
            break;
        case JYBIMMessageBodyTypeVideo:
            return JYBBCHttpUrl(@"/phone/SafetyInspectDiscussVideo!upMessage.action");
            break;
        default:
            return nil;
            break;
