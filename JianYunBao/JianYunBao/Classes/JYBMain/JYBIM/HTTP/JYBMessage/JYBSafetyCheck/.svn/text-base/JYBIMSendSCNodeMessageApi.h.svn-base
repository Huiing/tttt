...
@interface JYBIMSendSCNodeMessageApi : YTKRequest
 ...
 *
 *  @return `JYBIMSendSCNodeMessageApi`
 */
- (instancetype)initSafetyCheckNoteApiWithEnterpriseCode:(NSString *)enterpriseCode
