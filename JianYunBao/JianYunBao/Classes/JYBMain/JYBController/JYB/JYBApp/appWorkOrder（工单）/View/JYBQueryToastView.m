...
@implementation JYBQueryToastView
...
- (IBAction)selectResponsible:(id)sender {
  if(self.selectResponsiblerBlock)
  {
    self.selectResponsiblerBlock();
  }
}
- (IBAction)selectCreater:(id)sender {
  if(self.selectCreaterBlock)
  {
    self.selectCreaterBlock();
  }
