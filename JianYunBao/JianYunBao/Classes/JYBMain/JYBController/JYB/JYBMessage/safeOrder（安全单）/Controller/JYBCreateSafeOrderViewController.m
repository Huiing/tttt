//
//  JYBCreateSafeOrderViewController.m
//  JianYunBao
//
...
@interface JYBCreateSafeOrderViewController ()<TouchTableDelegate>
{
    UIView *_toastView;
    NSString *_projectId;
...
@implementation JYBCreateSafeOrderViewController
...
- (void)save{
    ...
    api.ReqURL = JYBBCHttpUrl(@"/phone/SafetyInspect!create.action");
    api.ReqDictionary =
    @{
      @"userId":userId,
